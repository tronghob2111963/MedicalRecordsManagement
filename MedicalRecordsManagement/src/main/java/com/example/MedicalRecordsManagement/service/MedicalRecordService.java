...
public interface MedicalRecordService {
    MedicalRecordDetailResponseDTO createMedicalRecord(MedicalRecordRequestDTO medicalRecordRequestDTO);
    ...
    MedicalRecordDetailResponseDTO getMedicalRecordDetail(Long id);
}
